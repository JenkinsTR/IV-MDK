...
if __name__ == "__main__":
    ...
    for lodgroup in odr_data["lodgroup"]:
        ...
        obj_headers = "# Converted by JMDigital\n\n"
        obj_headers += f"mtllib {output_mtl_name}\n\n"

        mtl_headers = "# Converted by JMDigital\n\n"
