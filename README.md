...
- **update_budget.bat** by JMDigital - [Link to File](Tools/Misc/IVTweaker_AutoUpdate_Vehicle_Budget/update_budget.bat)
- **UpdateVehicleBudget.ps1** by JMDigital - [Link to File](Tools/Misc/IVTweaker_AutoUpdate_Vehicle_Budget/UpdateVehicleBudget.ps1)
